...
class RptgeneralexoController extends Zend_Controller_Action {
	/**
	...
	public function indexexoneradosAction()
	{
		...
		$evt[] = array('#btnExportarProcesar_Exonerados', "click", "exportarExonerados();" );
	...
	public function reporte04Action()
    {
		...
		$rows = $cn->ejec_store_procedura_sql('[Rentas].[Rpt_Rentas_General]', $parametros);
			...
			$ini='<div align=center style="overflow:auto;height: 700px;padding:20px 0 0 0">';
			$cad1='';
			$parte1='<table border="1" class="hovertable" width="90%">
					<tr>';
			$parte2="<th colspan=18><center><b>EXONERADOS DE LA MDI DURANTE EL PERIODO ".$data_anio."</b></center></th>";
			$parte3='</tr>
					<tr>
						<th width="10%"><center><b>CODIGO</b></center></th>
						<th width="10%"><center><b>NOMBRE</b></center></th>
						<th width="5%"><center><b>T. PERSONA</b></center></th>
						<th width="10%"><center><b>TOT. AUTOAVALUO</b></center></th>
						<th width="5%"><center><b>B. IMPONIBLE</b></center></th>
						<th width="5%"><center><b>IMP. ANUAL</b></center></th>
						<th width="5%"><center><b>IMP. TRIME</b></center></th>
						
						<th width="5%"><center><b># PREDIOS</b></center></th>
						<th width="10%"><center><b>COD_PRED</b></center></th>
						<th width="10%"><center><b>ANEXO</b></center></th>
						<th width="20%"><center><b>DIR. PRED</b></center></th>
						<th width="10%"><center><b>USO</b></center></th>
						<th width="5%"><center><b>N. RESOL</b></center></th>
						<th width="5%"><center><b>F. RESO</b></center></th>
						
						<th width="5%"><center><b>EXPEDIENTE</b></center></th>
						<th width="10%"><center><b>B. LEGAL</b></center></th>
					</tr>';
			...
			for($i = 0; $i < count ( $rows ); $i ++) 
			{
				...
				$cad1.=	"<td align=left width=10%><b>".utf8_encode($rows[$i][1])."</b></td>";
				$cad1.=	"<td width=5%><center><b>".$rows[$i][3]."</b></center></td>";
				$cad1.=	"<td width=10%><center><b>".$rows[$i][4]."</b></center></td>";
				$cad1.=	"<td align=left width=5%><b>".utf8_encode($rows[$i][5])."</b></td>";
				$cad1.=	"<td width=5%><center><b>".$rows[$i][6]."</b></center></td>";
				$cad1.=	"<td width=5%><center><b>".$rows[$i][7]."</b></center></td>";
				
				$cad1.=	"<td width=5%><center><b>".$rows[$i][8]."</b></center></td>";
				$cad1.=	"<td align=left width=10%><b>".utf8_encode($rows[$i][9])."</b></td>";
				$cad1.=	"<td width=10%><center><b>".$rows[$i][10]."-".$rows[$i][11]."</b></center></td>";
				$cad1.=	"<td align=left width=20%><b>".utf8_encode($rows[$i][12])."</b></td>";
				$cad1.=	"<td align=left width=10%><b>".utf8_encode($rows[$i][14])."</b></td>";
				$cad1.=	"<td width=5%><center><b>".utf8_encode($rows[$i][15])."</b></center></td>";
				$cad1.=	"<td width=5%><center><b>".$rows[$i][16]."</b></center></td>";
				
				$cad1.=	"<td width=5%><center><b>".$rows[$i][17]."</b></center></td>";
				$cad1.=	"<td width=10%><center><b>".utf8_encode($rows[$i][18])."</b></center></td>";
	...
	*/
	...
	public function exportarrpt06Action()
    {
		$cn   	= new Model_DbDatos_Datos();
		...
		$parte1='<table border="1" class="hovertable" width="850PX">
				<tr>';
		$parte2="<th colspan=18 style='background-color:#4F81BD; color:#FFFFFF'><center><b>CANTIDAD DE EXONERADOS ".$anno."</b></center></th>";
		$parte3='</tr>
				<tr>
					<th width="10%"><center><b>CODIGO</b></center></th>
					<th width="50%"><center><b>NOMBRE</b></center></th>
    				<th width="15%"><center><b>T. PERSONA</b></center></th>
    				<th width="25%"><center><b>TOT.AUTOAVALUO</b></center></th>
					<th width="25%"><center><b>B.IMPONIBLE</b></center></th>
					<th width="25%"><center><b>IMP.ANUAL</b></center></th>
					<th width="25%"><center><b>IMP.TRIME</b></center></th>
					<th width="25%"><center><b>#PREDIOS</b></center></th>
					<th width="25%"><center><b>COD_PRED</b></center></th>
					<th width="25%"><center><b>ANEXO</b></center></th>
					<th width="25%"><center><b>DIR. PRED</b></center></th>
					<th width="25%"><center><b>USO</b></center></th>
					<th width="25%"><center><b>N.RESOL</b></center></th>
					<th width="25%"><center><b>F.RESO</b></center></th>
					<th width="25%"><center><b>EXPEDIENTE</b></center></th>
					<th width="25%"><center><b>B.LEGAL</b></center></th>
		...
		for($i = 0; $i < count ( $rows ); $i ++) 
        {
			...
			$cad1.='<tr>';
			$cad1.=	"<td width=10%><center><b>".$rows[$i][0]."</b></center></td>";
			$cad1.=	"<td width=15%><center><b>".$rows[$i][1]."</b></center></td>";
			...
			$cad1.=	"<td width=25%><center><b>".$rows[$i][7]."</b></center></td>";
			$cad1.=	"<td width=25%><center><b>".$rows[$i][8]."</b></center></td>";
			$cad1.=	"<td width=25%><center><b>".$rows[$i][9]."</b></center></td>";
			...
			$cad1.=	"<td width=25%><center><b>".$rows[$i][13]."</b></center></td>";
			$cad1.=	"<td width=25%><center><b>".$rows[$i][14]."</b></center></td>";
