...
class RentascajacoactivoController extends Zend_Controller_Action
{
	...
	//$evt[] = array('#btnpgcoactivo',"click","mostrarRecContri(3);");
	//$evt[] = array('#btnpg2013',"click","mostrarRecContri(2);");
