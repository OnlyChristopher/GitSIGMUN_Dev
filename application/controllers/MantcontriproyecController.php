...
class MantcontriproyecController extends Zend_Controller_Action
{
    ...
    {    	    	    	
		...
		$evt[] = array('#btnNewContri',"click","showPopup('mantcontrird/formu','#popcontri','720','440','Nuevo Contribuyente');");
    ...
    {    		
		...
		*/
		...
		$val[] = array('#cmbTipoContri',$fn->ContenidoCombo($arComboTipocontribuyente,'',trim($tipocontri)),'html');
