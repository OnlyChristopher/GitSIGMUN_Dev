...
class rentascajareccontriopController extends Zend_Controller_Action
{
...
public function conreccontriAction()
	{
		...
		*/
		...
		//$nombrestore='Caja.sp_EstCta_Rentasop';
		$nombrestore='Caja.sp_EstCta_Rentasop_proyectado';
