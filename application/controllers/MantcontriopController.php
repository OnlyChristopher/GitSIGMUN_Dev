...
class MantcontriopController extends Zend_Controller_Action
{
    ...
    {    	    	    	
		...
		$evt[] = array('#btnNewContri',"click","showPopup('mantcontriop/formu','#popcontri','720','440','Nuevo Contribuyente');");
