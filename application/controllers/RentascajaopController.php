...
class RentascajaopController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		//mio
		$evt[] = array('#btnProyeccion',"click","mostrarRecContri();");
		
		$evt[] = array('#btnGenerarop',"click","generarop();");
		
		//$evt[] = array('#txtFechaproyeccion',"datepicker","");
	...
	$contricaja = new Zend_Session_Namespace('contri');
	 ...
	 $val[] = array('#divDocu',"$numdoc","html");
	  ...
	  //$val[] = array('#txtFechaproyeccion',date('d/m/Y'),"val");
	...
	$val[] = array('#txtFechaproyeccion',$row_fecha[0][0],"val"); 	
