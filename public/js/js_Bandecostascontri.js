Ext.onReady(function(){
    ...
    Ext.define('Bajapre', {
        ...
        fields: [
			...
			{name: 'num_exp', type: 'string'},
			{name: 'ano_exp', type: 'string'}
        ]
    });
    ...
    var store = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url : 'bandecostascontri/consulta',
            reader: {
               type: 'json',
               root: 'rowsbaja'
            }
        ...
        Ext.create('Ext.grid.RowNumberer'),    
        {
            ...
            items: [/*{
                ...
                handler: function(grid, rowIndex, colIndex) {
                    ...
                    showPopup('bandecostascontri/costas?codigo='+rec.get('codigo'),'#popCostacontri','900','500','Costas Contribuyente');
					//showPopup('turncombinacion/formu?codigo='+rec.get('codigo')+'&prioridad='+rec.get('prioridad')+'&atencion='+rec.get('atencion'),'#popcombinacion','420','140','Editar Combinacion');
            ...
            },*/
			{
                ...
                handler: function(grid, rowIndex, colIndex) {
                    var rec = grid.getStore().getAt(rowIndex);
                    showPopup('bandecostascontri/bandejacostas?codigo='+rec.get('codigo'),'#popCostabandeja','900','500','Bandeja Costas');
					//showPopup('turncombinacion/formu?codigo='+rec.get('codigo')+'&prioridad='+rec.get('prioridad')+'&atencion='+rec.get('atencion'),'#popcombinacion','420','140','Editar Combinacion');
