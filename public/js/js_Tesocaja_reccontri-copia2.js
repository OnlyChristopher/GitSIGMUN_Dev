...
function deuda(est, obj){
	...
	//txtinso
		...
		dt += Number( obj.get('imp_insol')) ;
		dt=Math.round(dt*100)/100;
		$('#txtinso').val(dt);
	}else{
		dt=Number($('#txtinso').val());
		dt=Number(dt)-Number(obj.get('imp_insol'));
		dt=Math.round(dt*100)/100;
		$('#txtinso').val(dt);
	}
	...
	//txtreaj
		...
		dt += Number( obj.get('imp_reaj')) ;
		dt=Math.round(dt*100)/100;
		$('#txtreaj').val(dt);
	}else{
	//txtreaj
		dt=Number($('#txtreaj').val());
		dt=Number(dt)-Number(obj.get('imp_reaj'));
		dt=Math.round(dt*100)/100;
		$('#txtreaj').val(dt);
	}
	...
	//txtmora
		...
		dt += Number( obj.get('mora')) ;
		dt=Math.round(dt*100)/100;
		$('#txtmora').val(dt);
	}else{
	//txtmora
		dt=Number($('#txtmora').val());
		dt=Number(dt)-Number(obj.get('mora'));
		dt=Math.round(dt*100)/100;
		$('#txtmora').val(dt);
	}
	...
	//txtemis
		...
		dt += Number( obj.get('costo_emis')) ;
		dt=Math.round(dt*100)/100;
		$('#txtemis').val(dt);
	}else{
	//txtmora
		dt=Number($('#txtemis').val());
		dt=Number(dt)-Number(obj.get('costo_emis'));
		dt=Math.round(dt*100)/100;
		$('#txtemis').val(dt);
	}
