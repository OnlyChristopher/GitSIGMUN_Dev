        ...
        Ext.create('Ext.grid.RowNumberer'),    
        {
            ...
            items: [{
                ...
                handler: function(grid, rowIndex, colIndex) {  //+'&estado='+rec.get('expediente')
                    ...
                    showPopup('bandecostascontri/costas?codigo='+$('#divCodigo').html()+'&expediente='+rec.get('expediente')+'&estado='+rec.get('estado'),'#popCostacontri','900','500','Costas Contribuyente');
                    ...
                    var showResult = function(btn){
            			if(btn=='yes')  //si es 'yes' llamo al ajax
            				...
            				$.ajax({
                        		...
                        		data: 'idrecibo='+rec.get('idrecibo'),                        		
