        ...
        Ext.create('Ext.grid.RowNumberer'),    
        {
            ...
            items: [{
                ...
                handler: function(grid, rowIndex, colIndex) {
                    ...
                    var ruta='rentasdecjurada/index?codigo=';
                    var papup='#popdecjurada';
                    var largo='910';
                    var ancho='500';
                    var cabecera='Declaraci&oacute;n Jurada';
                ...
                handler: function(grid, rowIndex, colIndex) {
                    ...
                    var ruta='mantrepresentante/index?codigo=';
                    var papup='#poprepre';
                    var largo='1190';
                    var ancho='430';
                    var cabecera='Representante';
        ...
        Ext.create('Ext.grid.RowNumberer'),    
        {
            ...
            items: [{
                ...
                handler: function(grid, rowIndex, colIndex) {
                    ...
                    showPopup('rentascaja/index?codigo='+rec.get('codigo'),'#poptesore','1000','540','Rentas');
                },
                getClass: function(value,metadata,record){
                	if (mod=='02.01.00')
                		return gridColumnAction(false);
